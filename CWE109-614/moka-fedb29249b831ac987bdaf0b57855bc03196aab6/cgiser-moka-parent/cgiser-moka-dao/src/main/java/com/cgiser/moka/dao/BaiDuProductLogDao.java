...
public class BaiDuProductLogDao {
	...
	public Map<String, Object> getBaiDuProductLogByCooOrderSerial(String cooOrderSerial) {
	...
	public List<Map<String, Object>> getBaiDuProductLogByRoleIdPayment(Long roleId,int payment) {
