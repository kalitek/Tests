...
public class MMProductLogDao {
	...
	public Map<String, Object> getMMProductLogByCooOrderSerial(String cooOrderSerial) {
	...
	public List<Map<String, Object>> getMMProductLogByRoleIdPayment(Long roleId,int payment) {
