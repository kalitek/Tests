...
public class NineOneSdk {
	 ...
	 */
	public JSONObject queryPayResult(String cooOrderSerial)  throws Exception{
		String act = "1";
	 ...
	 * @throws Exception
	 */
	public JSONObject checkUserLogin(String uin,String sessionID) throws Exception{
		String act = "4";
		StringBuilder strSign = new StringBuilder();
		strSign.append(appid);
		strSign.append(act);
	 ...
	 */
	public int payResultNotify(String act, String productName,String consumeStreamId,
		...
		if("1".equals(payStatus)){
			try {
				if(Integer.parseInt(queryPayResult(cooOrderSerial).getString("ErrorCode")) == 1){
					payResult = 1; //有订单
				}
				else{
					payResult = 11; //无订单
	 ...
	 * @throws Exception
	 */
	private JSONObject GetResult(String jsonStr) throws Exception{
...
//		return Integer.parseInt(jo.getString("ErrorCode"));
	...
	public static void main(String[] args) {
		NineOneSdk sdk = new NineOneSdk();
		try {
			sdk.setAppid("111028");
			sdk.setAppkey("a0472413f5577146f4834f899d2de5ca32c3663fef61ff3b");
			JSONObject obj = sdk.queryPayResult("b8a420ee-b838-45e6-bceb-4b3656acf9ea");
