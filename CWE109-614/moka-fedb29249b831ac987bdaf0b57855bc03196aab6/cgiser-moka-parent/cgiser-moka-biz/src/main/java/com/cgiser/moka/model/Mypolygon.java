...
public  class Mypolygon implements Shape, java.io.Serializable{
	...
	void calculateBounds(double xpoints[], double ypoints[], int npoints) {
		...
		bounds = new MyRectangle(boundsMinX, boundsMinY,
	...
	public PathIterator getPathIterator(AffineTransform at) {
		return new PolygonPathIterator(this, at);//new PolygonPathIterator(this, at);
	}
	...
	class PolygonPathIterator implements PathIterator {
		...
		public PolygonPathIterator(Mypolygon mypolygon, AffineTransform at) {
			poly = mypolygon;
			transform = at;
		 ...
		 */
		public int currentSegment1(double[] coords) {
