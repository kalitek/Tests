...
public class JoinLegionFightAction extends AbstractAction {
	Logger logger = LoggerFactory.getLogger(this.getClass());
	public ActionForward execute(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response){
		ReturnType<LegionCity> returnType = new ReturnType<LegionCity>();
...
//			LegionCity legionCity = legionFightManager.inLegionFight(city, role.getRoleId(),role.getRoleName());
			returnType.setStatus(1);
//			returnType.setValue(legionCity);
			super.printReturnType2Response(response, returnType);
		}catch (Exception e) {
