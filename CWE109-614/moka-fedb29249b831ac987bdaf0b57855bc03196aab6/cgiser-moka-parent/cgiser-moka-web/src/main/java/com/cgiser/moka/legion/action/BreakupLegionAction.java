...
public class BreakupLegionAction extends AbstractAction {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		try{
			...
			if(legionManager.breakupLegion(legioner.getLegionId())>0){				
				returnType.setMsg("解散帮派失败！");
				returnType.setStatus(0);
				super.printReturnType2Response(response, returnType);
				return null;
			}
			legionManager.saveLegionEvent(legioner.getLegionId(),legioner.getRoleId(), role.getRoleName()+"解散了帮派", LegionEventEnum.BREAKEUPLEGION.getCode());
